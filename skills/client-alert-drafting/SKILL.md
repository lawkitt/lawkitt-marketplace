...
description: >-
  Draft professional legal client alerts and publications that inform clients
  about significant legal developments. Use when asked to: write a client alert,
  draft a legal update, create a publication about new
  legislation/regulations/case law, or prepare a legal briefing for clients.
  Supports all practice areas including corporate, litigation, regulatory,
  employment, tax, IP, and more. Output available as Word (.docx) or Markdown
  (.md).
metadata:
  author: Skala Inc.
  license: Apache-2.0
  ...
  source:
    repository: 'https://github.com/skala-io/legal-skills'
    path: skills/client-alert-drafting
---
